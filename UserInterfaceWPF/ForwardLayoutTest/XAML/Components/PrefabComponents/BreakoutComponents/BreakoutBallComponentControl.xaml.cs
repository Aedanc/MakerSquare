...
{
    [Serializable]
    public class BreakoutBallComponentSerializedData : ISerializedComponent
    {        
        public string ball_sprite;     

        public void SetComponentData(Entity entity)
        {
            var breakout = new BreakoutBallComponentControl(entity);
            entity.AddComponent(breakout);
        }
    }

    public partial class BreakoutBallComponentControl : UserControl, IComponent
    {
        ...
        public BreakoutBallComponentControl(Entity entity)
        {
            InitializeComponent();
        ...
        {
            var data = new BreakoutBallComponentSerializedData();
            data.ball_sprite = spriteName;
            entity._serializedComponents.Add(data);
        }

        public void FillData()
        {
            var data = new FFBreakoutBallComponent(selectedEntity);
